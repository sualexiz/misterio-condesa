...
export class PostService {
  ...
  private capitulos: Capitulos[] = [

    {
      ...
      descripcion: 'Después de estar perdidos por un largo tiempo, Rosario y Matías por fin llegan a la finca La Condesa con el objetivo de pasar un gran fin de semana en junto a otros compañeros de su universidad. Antonio, el mayordomo de la finca, es el primero en recibirlos y les informa que sus amigos no han llegado. Al entrar, conocen a Rafael, el dueño del lugar, quien les muestra las instalaciones y les asegura que van a pasar uno días inolvidables.<br> Ya solos, Matías pone en marcha su plan de conquista y se le acerca a Rosario, mientras Rafael se conecta en la red, mostrándoles a los usuarios todo lo que pasa con esta pareja en tiempo real.',
...

    {
      ...
      video: 'link',
      descripcion: 'Mientras Rosario y Matías intentan dormir, extrañas sombras rondar a la pareja, ratificando que fuera de normal sucede en La Condesa. Estos raros acontecimientos aumentan el interés de las personas que se han conectado con la transmisión de Rafael.<br> Al despertar, se percatan que sus amigos no han llegado y deciden recorrer el lugar en la búsqueda de señal para el celular, para tratar de localizar a sus compañeros ya que desde la finca no se pueden hacer llamadas. Rosario empieza a desconfiar de Matías y decide regresar a la ciudad.',
      tupuedes: 'Tú puedes elegir el destino de esta historia',
      iframeFB: 'votar'
    },
    ...
    },
    {
      ...
      video: 'link',
      descripcion: 'Matías sufre un fuerte dolor pero sin importar su padecimiento va con Rosario a la casa de Antonio para les ayude a contactar a Rafael y a salir de La Condesa. Una vez allí descubren cientos de artículos extraños regados por la casa del mayordomo lo que hace desconfiar a la pareja aún más de él.<br> Rosario le insiste a Antonio que deben llamar a Rafael para que los ayude a salir de la finca, pero este misterioso personaje hará todo lo que este a su alcance para evitarlo.',
      tupuedes: 'Tú puedes elegir el destino de esta historia',
      iframeFB: 'votar'
    },
  ...
  postDoc: AngularFirestoreDocument<Post>;b
